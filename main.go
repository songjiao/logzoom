...
import (
	...
	_ "github.com/songjiao/logzoom/input/filebeat"
	_ "github.com/songjiao/logzoom/input/redis"
	_ "github.com/songjiao/logzoom/input/kafka"
	_ "github.com/songjiao/logzoom/output/elasticsearch"
	_ "github.com/songjiao/logzoom/output/redis"
	_ "github.com/songjiao/logzoom/output/s3"
	_ "github.com/songjiao/logzoom/output/tcp"
	_ "github.com/songjiao/logzoom/output/websocket"
	"github.com/songjiao/logzoom/server"
	"net/http"
	_ "net/http/pprof"
	"runtime"
	"runtime/pprof"
